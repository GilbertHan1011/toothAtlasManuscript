...
if (!dir.exists(process_dir)) {
  dir.create(process_dir, recursive = TRUE)
}
mrtree_input_labels <- data.table::fread("processed_data/metadata//20241030_epi_anno_mrtree_input_label.csv")
...
saveRDS(mrtree_res,paste0(process_dir,"epi_mrtree.Rds"))
...
###Save
##########
saveRDS(cluster_object,paste0(process_dir,"20241030_epi_cluster_object.Rds"))
# # save object as rds
