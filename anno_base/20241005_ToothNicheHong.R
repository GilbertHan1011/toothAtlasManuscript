...
baseName <- "ToothNiche_Hong" # You should change this.
...
dput(levels(seurat))
newID <- c('Mesenchyme','Mesenchyme','Mesenchyme','Epithelium','Mesenchyme','Mesenchyme','Epithelium', 'Epithelium', 'Epithelium', 'Mesenchyme','Epithelium', 'Mesenchyme','Epithelium', 'Immune', 'Endothelium', 'Mesenchyme','perivascular', 'RBC', 'muscle', 'neuron')
