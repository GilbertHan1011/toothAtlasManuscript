...
baseName <- "Runx2_Shuo" # You should change this.
...
dput(levels(seurat))
newID <- c('Mesenchyme','Mesenchyme','Mesenchyme','Mesenchyme','Epithelium', 'Mesenchyme','Immune', 'Epithelium','Epithelium','Immune', 'Endothelium', 'Mesenchyme')
