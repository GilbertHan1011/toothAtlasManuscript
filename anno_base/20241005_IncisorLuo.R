...
baseName <- "Incisor_Luo" # You should change this.
...
dput(levels(seurat))
newID <- c('Mesenchyme','Epithelium', 'Mesenchyme','Mesenchyme','Mesenchyme','Epithelium', 'Epithelium','Epithelium','Mesenchyme','Mesenchyme','Mesenchyme','Epithelium','Mesenchyme','Endothelium','Epithelium','Immune', 'Epithelium','Epithelium','RBC', 'Mesenchyme', 'Epithelium', 'neuron', 'perivascular', 'muscle' )
