...
baseName <- "Follile_Akira" # You should change this.
...
dput(levels(seurat))
newID <- c('Endothelium', 'Mesenchyme','Immune', 'Mesenchyme','Immune', 'Mesenchyme','Immune', 'Mesenchyme','perivascular','Mesenchyme','Immune', 'Immune','Immune','Epithelium', 'RBC', 'neuron','Mesenchyme','Endothelium','Immune','Immune','Endothelium'  )
