...
baseName <- "Molar_Qian" # You should change this.
...
dput(levels(seurat))
newID <- c('Epithelium', 'Mesenchyme','Epithelium', 'Mesenchyme','Mesenchyme','Mesenchyme','Epithelium', 'Endothelium', 'Epithelium', 'Mesenchyme','perivascular and neuron', 'Immune', 'Mesenchyme','Epithelium', 'Epithelium')
