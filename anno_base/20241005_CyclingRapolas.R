...
baseName <- "Cycling_Rapolas" # You should change this.
...
dput(levels(seurat))
newID <- c('Epithelium','Epithelium','Immune','Epithelium','Epithelium','Epithelium','Epithelium','Epithelium','Epithelium','Epithelium','Epithelium','Mesenchyme', 'Immune', 'Epithelium')
